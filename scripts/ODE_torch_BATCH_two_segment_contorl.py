...
if __name__ == "__main__":
    ...
    controller.load_state_dict(torch.load("/home/mohammad/SoftRobot_CORL23/trainedModel/model_controller_20240902-205342.zip"))
    ...
    for i in range(5):
        ...
        actions = controller(target_tip_position)
    ...
    for epoch in range(num_epochs):
        ...
        loss = 1000*loss_fn(final_tip_position, target_tip_position)
